...
extern "C" {
     ...
     */
    LIBRARY_API double* LineSegmentDetection(int* n_out,
    ...
    /** LSD Simple Interface with Scale and Region output.
        ...
        @return            A double array of size 7 x n_out, containing the list
                           ...
                           'out[7*n+0]' to 'out[7*n+6]'.
     */
    LIBRARY_API double* lsd_scale_region(int* n_out,
    ...
    /** LSD Simple Interface with Scale
        ...
        @return            A double array of size 7 x n_out, containing the list
                           ...
                           'out[7*n+0]' to 'out[7*n+6]'.
     */
    LIBRARY_API double* lsd_scale(int* n_out, double* img, int X, int Y, double scale);
    ...
    /** LSD Simple Interface
        ...
        @return            A double array of size 7 x n_out, containing the list
                           ...
                           'out[7*n+0]' to 'out[7*n+6]'.
     */
    LIBRARY_API double* lsd(int* n_out, double* img, int X, int Y);

    /**
    * free memory allocated by lsd for return array
    *
    */
    LIBRARY_API void free_lines(double* rtv);
